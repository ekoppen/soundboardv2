      ...
      $(".container").append(
        $(
          '<div class="sound-wrapper" id="' +
            ...
            "</span></div>" +
            "</a>" +
            audio.attr("onended", "linksAan(this.id, this.duration)")
        ).click(function () {
          ...
          if (that.paused == false) {
            ...
            that.pause();
            that.currentTime = 0;
            linksAan(this.id, this.duration);
            //alert('music paused');
          } else {
            that.play();
            //alert('music playing');
            ...
            function timeUpdate() {
              ...
              $(".sound-wrapper#" + this.id + " .duration").css("visibility","hidden");
              $(".sound-wrapper#" + this.id + " .duration-counter").css("visibility","visible").text(
